...
export default async (request: Request) => {
  ...
  const secret = env("STRIPE_SECRET_KEY") || env("STRIPE_RESTRICTED_KEY") || env("PAYMENT_SECRET_KEY");
  const webhookSecret = env("STRIPE_WEBHOOK_SECRET") || env("PAYMENT_WEBHOOK_SECRET");
